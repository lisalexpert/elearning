...
$PAGE->requires->css('/theme/' . $CFG->theme . '/style/book_print.css');
...
if ($chapter) {
    ...
    ?>
    <a name="top"></a>
    <div class="book-print-headerbar">
    <table>
    <tr>
        <td>
            <img width="145" 
            src="<?php echo $CFG->wwwroot;?>/informea_logo.png" 
            alt="<?php echo $SITE->shortname; ?>" 
            title="<?php echo $SITE->shortname; ?>" />
        </td>
        <td>
            <span class="book-print-logo-text">
            This learning material is part of a course in the InforMEA e-learning platform, 
            go to <a href="https://elearning.informea.org">https://elearning.informea.org</a> 
            to take the complete course and obtain your certificate.
            </span>
        </td>
    </tr>
    </table>
