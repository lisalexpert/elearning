...
$string['takecourse'] = 'Take the course';

// Custom
$string['ncourses'] = '{$a} courses';
$string['ourcourses'] = 'Our courses';
$string['othercourses'] = 'Other courses';
$string['downloadflyer'] = 'Download Syllabus';
$string['signup'] = 'Sign up';
$string['login'] = 'Log in';
$string['registerheader'] = 'Register to<br />InforMEA Learning';
$string['registersocialheader'] = 'Sign in<br />using your social account';
$string['loginheader'] = 'Login in<br />InforMEA Learning';
$string['firstnamereq'] = 'First Name*';
$string['lastnamereq'] = 'Last Name*';
$string['emailreq'] = 'Email Address*';
$string['setpassreq'] = 'Set a Password*';
$string['passreq'] = 'Password*';
