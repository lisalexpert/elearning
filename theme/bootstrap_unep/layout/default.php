...
$theme_title = "United Nations Environment Programme";
echo $OUTPUT->doctype() ?>
...
<nav role="navigation" class="navbar navbar-default">
  <div class="container">
    <div id="menu_top_1" class="desktop_only">
      <span id="theme_title"><?php echo $theme_title; ?></span>
      <div class="user_menu theme_menu"><?php echo $OUTPUT->user_menu(); ?></div>
    </div>
    <div class="navbar-header">
      ...
      <a id="tounep" class="navbar-brand" href="http://www.unenvironment.org/">
        <img src="<?php echo $OUTPUT->pix_url('UNEP_Logo','theme'); ?>" alt="<?php echo htmlspecialchars($theme_title); ?>" title="<?php echo htmlspecialchars($theme_title); ?>" />
      </a>
      <div id="menu_top_2" class="custom_menu desktop_only theme_menu"><?php echo $OUTPUT->custom_menu(); ?></div>
    </div>
...
var menu_pos = 0;
var check_menu_pos = function(){
  var win_width = $(window).outerWidth();
  if(!menu_pos && win_width < 768){
    menu_pos = 1;
    $('#navbar-menu2').appendTo($('#moodle-navbar'));
    $('#navbar-menu').appendTo($('#moodle-navbar'));
  } else if(menu_pos && win_width >= 768){
    menu_pos = 0;
    $('#navbar-menu2').appendTo($('#menu_top_1 > .theme_menu'));
    $('#navbar-menu').appendTo($('#menu_top_2'));
  }
}
