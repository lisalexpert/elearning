...
class block_contact_form extends block_base {
    ...
    function specialization() {
        ...
        if ($CFG->block_contact_form_email) {
			$this->email = $CFG->block_contact_form_email;
		} else {
    ...
    function get_content() {
        ...
        if ( !($allhiddenrecipients || $allstandardrecipients || $this->email) ) {
            ...
            if ($displaytype == 1){
                ...
                $this->content->text .= '<p>'.get_string('contactus_course','block_contact_form').'</p>';
                $this->content->text .= '<div style="text-align: center;">';
