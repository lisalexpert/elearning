...
$string['auth_sign-in_with'] = 'Вход в систему с {$a->providername}';
$string['moreproviderlink'] = 'Sign-in with another service.';
$string['signinwithanaccount'] = 'Войти с:';
...
$string['signupwithsocialaccount'] = 'Зарегистрироваться с вашей социальной счет';
$string['or'] = 'ИЛИ';