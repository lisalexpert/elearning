...
$string['auth_sign-in_with'] = 'Inscrivez-avec {$a->providername}';
$string['moreproviderlink'] = 'Sign-in with another service.';
$string['signinwithanaccount'] = 'Connectez-vous avec:';
...
$string['signupwithsocialaccount'] = 'Enregistrez-vous avec votre compte sociale';
$string['or'] = 'OU';